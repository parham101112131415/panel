...
export type ColorTheme = 'parham' | 'default' | 'inverse' | 'red' | 'rose' | 'pink' | 'orange' | 'amber' | 'yellow' | 'green' | 'teal' | 'cyan' | 'blue' | 'indigo' | 'violet'
...
export const accentThemes: Record<ColorTheme, ColorThemeConfig> = {
  parham: accentOverlay('Parham', '0 84% 45%', '0 0% 98%', '0 84% 58%', '0 0% 98%', ['0 84% 50%', '15 95% 52%', '30 95% 55%', '0 65% 38%', '0 45% 28%'], ['0 84% 58%', '15 95% 62%', '30 95% 66%', '0 70% 48%', '0 50% 32%']),
...
export const colorThemeOrder: ColorTheme[] = ['parham', 'default', 'inverse', 'red', 'rose', 'pink', 'orange', 'amber', 'yellow', 'green', 'teal', 'cyan', 'blue', 'indigo', 'violet']
